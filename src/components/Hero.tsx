            ...
            <div className="flex flex-col items-start text-left space-y-8 z-10">
                ...
                >
                    ...
                    <a
                        ...
                        className="bg-white text-brand-900 border-2 border-brand-100 font-semibold py-4 px-8 rounded-2xl hover:bg-brand-50 hover:border-brand-200 transition-all flex items-center gap-3 text-lg"
                    >
                        <Instagram size={20} />
                        Follow Us
                    </a>
            ...
            <div className="relative h-125 hidden lg:block">
                ...
                >
                    <div className="aspect-square bg-gray-100 rounded-xl mb-3 overflow-hidden">
                        <img src="/p1.jpg" className="w-full h-full object-cover" alt="Chips" />
                    </div>
                ...
                >
                    <div className="aspect-square bg-gray-100 rounded-xl mb-3 overflow-hidden">
                        <img src="/p3.jpg" className="w-full h-full object-cover" alt="Murukku" />
                    </div>
                    <div className="h-2 w-2/3 bg-gray-200 rounded mb-2"></div>
                    <div className="h-2 w-1/2 bg-gray-200 rounded"></div>
                </motion.div>
                ...
                >
                    <div className="aspect-square bg-gray-100 rounded-xl mb-3 overflow-hidden">
                        <img src="/p2.jpg" className="w-full h-full object-cover" alt="Mixture" />
                    </div>
